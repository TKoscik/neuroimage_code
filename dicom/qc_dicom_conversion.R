...
write("", rmd.fid, sep="\n", append=TRUE)
write('pkg.ls <- c("nifti.io", "htmltools", "R.utils", "ggplot2", "reshape2", "gridExtra", "grid", "rmarkdown")', rmd.fid, sep="\n", append=TRUE)
...
write("***", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write(paste0("Parent Directory: __", researcher, "/", project, "__  "), rmd.fid, sep="\n", append=TRUE)
...
write("***", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write(paste0(researcher, "/", project, "/nifti/sub-", subject, "/ses-", session, "/  "), rmd.fid, sep="\n", append=TRUE)
write("```{bash}", rmd.fid, sep="\n", append=TRUE)
write(paste0("tree -f ", researcher, "/", project, "/nifti/sub-", subject, "/ses-", session, " \\"), rmd.fid, sep="\n", append=TRUE)
write(paste0("  -H ", dir.input, "/", prefix, "_nifti-tree.html \\"), rmd.fid, sep="\n", append=TRUE)
write(paste0("  -o ", dir.input, "/", prefix, "_nifti-tree.html \\"), rmd.fid, sep="\n", append=TRUE)
write('  --nolinks --noreport', rmd.fid, sep="\n", append=TRUE)
write(paste0("sed -i \'31d\' ", dir.input, "/", prefix, "_nifti-tree.html"), rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write("for i in {1..13}; do", rmd.fid, sep="\n", append=TRUE)
write(paste0("  sed -i \'$d\' ", dir.input, "/", prefix, "_nifti-tree.html"), rmd.fid, sep="\n", append=TRUE)
write("done", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write(paste0("echo \"</body>\" >> ", dir.input, "/", prefix, "_nifti-tree.html"), rmd.fid, sep="\n", append=TRUE)
write(paste0("echo \"</html>\" >> ", dir.input, "/", prefix, "_nifti-tree.html"), rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write("```", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write("```{r}", rmd.fid, sep="\n", append=TRUE)
write(paste0("x <- readLines(\"", dir.input, "/", prefix, "_nifti-tree.html\")"), rmd.fid, sep="\n", append=TRUE)
write("x <- x[-which(x==\"\\t<h1>Directory Tree</h1><p>\")]", rmd.fid, sep="\n", append=TRUE)
write(paste0("writeLines(x, con=\"", dir.input, "/", prefix, "_nifti-tree.html\", sep = \"\\n\")"), rmd.fid, sep="\n", append=TRUE)
write(paste0("includeHTML(\"", dir.input, "/", prefix, "_nifti-tree.html\")"), rmd.fid, sep="\n", append=TRUE)
write("```", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
write("***", rmd.fid, sep="\n", append=TRUE)
write("", rmd.fid, sep="\n", append=TRUE)
